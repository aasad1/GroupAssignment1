...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { building: @office.building, professor_id: @office.professor_id, room_number: @office.room_number } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { building: @office.building, professor_id: @office.professor_id, room_number: @office.room_number } }
